...
function writeFakeNpm(binDir, options = {}) {
  ...
  const currentTags = options.currentTags || { latest: '2.1.178', candidate: '2.1.179' };
...
function runRetagTest(options = {}) {
  ...
  const env = {
    ...
    CLAUDE_TERMUX_EXPECTED_PREVIOUS_AUDITED_VERSION: options.previousAuditedVersion || '2.1.178',
  };
