## 2.1.282 — 2026-09-25 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.282 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
```sh
npm install -g @bash0816/claude-code@2.1.281
```

---
## 2.1.281 — 2026-09-25 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.281 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
```sh
npm install -g @bash0816/claude-code@2.1.280
```

---
## 2.1.280 — 2026-09-23 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.280 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
```sh
npm install -g @bash0816/claude-code@2.1.278
```
...
```sh
npm install -g @bash0816/claude-code@2.1.270
```

---
## 2.1.270 — 2026-09-13 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.270 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
```sh
npm install -g @bash0816/claude-code@2.1.269
```

---
## 2.1.269 — 2026-09-12 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.269 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
```sh
npm install -g @bash0816/claude-code@2.1.268
```

---
## 2.1.268 — 2026-09-12 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.268 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
---
## 2.1.265 — 2026-09-11 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.265 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
---
## 2.1.263 — 2026-09-06 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.263 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
```sh
npm install -g @bash0816/claude-code@2.1.261
```

---
## 2.1.261 — 2026-09-05 ✅ Current audited / 現在の監査済み版

upstream claude-code 2.1.261 追従。Termux 実機検証済み（全テスト通過 / TUI 起動確認）。
...
```sh
npm install -g @bash0816/claude-code@2.1.260
```
