...
| Version | Status |
|---------|--------|
| `2.1.278` | ✅ **Recommended / 推奨** — latest |
| `2.1.276-1` | ✅ rollback version |
...
Official upstream (`@anthropic-ai/claude-code`): latest `2.1.269` / stable `2.1.236`
This repo's latest audited release (release manifest): `2.1.268`

公式 upstream (`@anthropic-ai/claude-code`): latest `2.1.269` / stable `2.1.236`
この repo の latest audited release (release manifest 基準): `2.1.268`
